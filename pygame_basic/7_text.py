...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/aidi0/Desktop/python-tutorial/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/aidi0/Desktop/python-tutorial/pygame_basic/enemy.png")
...
while running:
    ...
    # 충돌 체크
    if character_rect.colliderect(enemy_rect): # colliderect() : 충돌을 확인하는 함수
        print("충돌했어요")
        running = False
